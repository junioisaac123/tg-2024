            ...
            'route' => 'admin.permissions.index',
                        ...
                        <li>
                            <a href="{{ route($item['route']) }}"
                                class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">{{ __($item['name']) }}</a>
                        </li>
                    @endforeach
                    {{-- <li>
                        <a href="#"
